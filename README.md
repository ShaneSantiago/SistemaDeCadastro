...
<!-- PROJECT TITLE -->
<h1 align='center'id="top"> :rocket: == Site de Produtos == :rocket: </h1>


<!-- PROJECT SOBRE -->
<h2 id="sobre">:notebook: Sobre </h2>

<p align="justify">Basta clonar o repositório e logo após abrir o código usar o comando npm install e npm start para o projeto ficar online. Abaixo tem um link com o projeto já funcionando online</p>

<p align="justify">Um projejo no qual lista alguns produtos e também podem ser criado novos produtos, porém para ter acesso a lista de produtos você deve ter uma conta</p>
...
### Telas
- [x] Tela inicial;
- [x] Tela com lista de produtos;
- [x] Tela para cadastrar produtos;
- [x] Tela de login;
- [x] Tela para criar conta

### Integração com API
- [x] Listagem de Produtos;
- [x] Get Produtos;
- [x] Get Produtos details;
- [x] Post Produtos;
- [x] Get Usuários;
- [x] Post Usuário;
- [x] Post Login;
